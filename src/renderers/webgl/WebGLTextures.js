		...
		if ( renderTarget.multipleSampling > 0 ) {
			...
			if ( capabilities.isWebGL2 ) {
				...
				if ( textureTarget === 3553 ) {
					...
					_gl.renderbufferStorageMultisample( 36161, Math.min( renderTarget.multipleSampling, 8 ), _gl.RGBA8, renderTarget.width, renderTarget.height );
	...
	function setupRenderBufferStorage( renderbuffer, renderTarget ) {
		...
		if ( renderTarget.depthBuffer && ! renderTarget.stencilBuffer ) {
			...
			if ( capabilities.isWebGL2 && renderTarget.multipleSampling > 0 ) {
				...
				// @THREE-Modification
				_gl.renderbufferStorageMultisample( _gl.RENDERBUFFER, Math.min( renderTarget.multipleSampling, 8 ), _gl.DEPTH_COMPONENT16, renderTarget.width, renderTarget.height );
			...
			if ( capabilities.isWebGL2 && renderTarget.multipleSampling > 0 ) {
				...
				// @THREE-Modification
				_gl.renderbufferStorageMultisample( _gl.RENDERBUFFER, Math.min( renderTarget.multipleSampling, 8 ), _gl.DEPTH24_STENCIL8, renderTarget.width, renderTarget.height );
