...
function WebGLRenderer( parameters ) {
	...
	this.render = function ( scene, camera ) {
		...
		const custom1Objects = currentRenderList.custom1; // @THREE-Modification
		const opaqueObjects = currentRenderList.opaque;
		const transparentObjects = currentRenderList.transparent;

		if ( custom1Objects.length && this.renderCustom1 ) { // @THREE-Modification custom1 pass
			...
			if ( object.isGroup ) {
				...
				if ( object.isSkinnedMesh ) {
					...
					if ( object.skeleton.frame !== info.render.frame ) {
						...
						object.skeleton.update( object ); // @THREE-Modification Pass object as argument.
	...
	function setProgram( camera, scene, material, object ) {
		...
		if ( refreshMaterial ) {
			...
			// @THREE-Modification for color mapping
